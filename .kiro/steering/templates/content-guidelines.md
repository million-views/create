...
description: "Comprehensive guidelines for creating and maintaining documentation content following Diátaxis framework principles"
prerequisites:
  - "Basic understanding of Diátaxis framework"
...
**Note**: Documentation templates and guidelines are provided in `.kiro/steering/templates/` (methodology guidance for AI assistants).
