  ...
  rules: {
    ...
    'wrangler.jsonc': [
      ...
      },
      {
        ...
        placeholder: 'D1_DATABASE_BINDING'
      },
      {
        context: 'application/json',
        path: '$.d1_databases[0].database_name',
        placeholder: 'D1_DATABASE_NAME'
      },
      {
        context: 'application/json',
    ...
    'wrangler.toml': [
      {
        context: 'application/toml',
        path: 'account_id',
        placeholder: 'CLOUDFLARE_ACCOUNT_ID'
      },
      {
        context: 'application/toml',
        path: 'd1_databases.binding',
        placeholder: 'D1_DATABASE_BINDING'
      },
      {
        context: 'application/toml',
        path: 'd1_databases.database_name',
        placeholder: 'D1_DATABASE_NAME'
      },
      {
        context: 'application/toml',
        path: 'd1_databases.database_id',
        placeholder: 'D1_DATABASE_ID'
      }
    ],
    '.jsx': [
