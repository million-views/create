...
> Note: Template repositories now include a `.template-undo.json` file generated by the template commands. Keep this file checked in—it supports template authors during local iterations—but `@m5nv/create` automatically ignores it during copying, dry runs, and setup runtime operations.
...
│       ├── index.mts                 # Main CLI router
│       └── domains/                  # Domain-specific implementations
│           ├── scaffold/             # Scaffold domain
│           │   ├── router.mts        # Scaffold command router
│           │   ├── commands/         # Individual scaffold subcommands
│           │   │   ├── new/          # Project creation command
│           │   │   ├── list/         # Template listing command
│           │   │   └── validate/     # Template validation command
│           │   └── modules/          # Shared scaffold modules
...
│               ├── router.mts        # Template command router
│               └── commands/         # Template subcommands
│                   ├── init/         # Initialize template configuration
│                   ├── convert/      # Project-to-template conversion
│                   ├── restore/      # Template-to-project restoration
│                   ├── validate/     # Template validation
│                   ├── hints/        # Authoring hints display
│                   └── test/         # Template testing
├── lib/                              # Shared library code
│   ├── cli/                          # CLI framework (BaseCommand, Router)
│   ├── error/                        # Error handling infrastructure
│   ├── security/                     # Security validation
│   ├── template/                     # Template processing
│   ├── placeholder/                  # Placeholder resolution
│   ├── templatize/                   # Templatization engine
│   └── validation/                   # Input validation
├── docs/                             # User and developer documentation
├── tests/                            # Comprehensive test suites
│   ├── scaffold/                     # Scaffold domain tests
...
|-------|---------|---------|------------------|-------|
| **Unit** | `npm run test:unit` | Core components & infrastructure | **Foundation** | ⚡ Fast |
| **Integration** | `npm run test:integration` | Command-level functionality | **Feature** | 🚀 Medium |
| **System** | `npm run test:system` | Full end-to-end workflows | **Production** | 🐌 Slow |
