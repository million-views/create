...
// Import and re-export GateError from the error domain for backward compatibility
// Keep the original name SecurityGateError as an alias
import { GateError } from './error/index.mts';
export { GateError as SecurityGateError };

// Local alias for internal use
const SecurityGateError = GateError;
