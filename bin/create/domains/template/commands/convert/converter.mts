...
import { ErrorContext, ErrorSeverity, handleError } from '@m5nv/create/lib/error/handler.mts';
import { loadConfig, loadConfigFromFile, getPatternsForFile } from '@m5nv/create/lib/templatize/strategy/config.mts';
import { processJSONFile } from '@m5nv/create/lib/templatize/strategy/json.mts';
import { processMarkdownFile } from '@m5nv/create/lib/templatize/strategy/markdown.mts';
import { processJSXFile } from '@m5nv/create/lib/templatize/strategy/jsx.mts';
import { processHTMLFile } from '@m5nv/create/lib/templatize/strategy/html.mts';
import { formatPlaceholder as formatPlaceholderToken, normalizeFormat } from '@m5nv/create/lib/placeholder/format.mts';
...
export class Converter {
  ...
  getProcessorTypeForFile(filePath) {
    ...
    if (ext === '.jsx' || ext === '.tsx' || ext === '.mts' || ext === '.ts') return 'jsx';
