...
export class Logger {
  ...
  error(message, data = null) {
    if (this.mode === 'file') {
      ...
      this.writeLogEntrySync(logEntry);
    } else if (this.mode === 'console' && this.levels[this.level] >= this.levels.error) {
  ...
  warn(message, data = null) {
    if (this.mode === 'file') {
      ...
      this.writeLogEntrySync(logEntry);
    } else if (this.mode === 'console' && this.levels[this.level] >= this.levels.warn) {
  ...
  info(message, data = null) {
    if (this.mode === 'file') {
      ...
      this.writeLogEntrySync(logEntry);
    } else if (this.mode === 'console' && this.levels[this.level] >= this.levels.info) {
  ...
  debug(message, data = null) {
    if (this.mode === 'file') {
      ...
      this.writeLogEntrySync(logEntry);
    } else if (this.mode === 'console' && this.levels[this.level] >= this.levels.debug) {
