...
export class TemplateValidator {
  ...
  validateDomain(templateData) {
    ...
    if (templateData.dimensions?.features?.values && templateData.featureSpecs) {
      errors.push(...this.validateAllFeaturesHaveSpecs(templateData.dimensions.features.values, templateData.featureSpecs));
    }
   ...
   * @param {object} selectedValues - Selected dimension values (e.g., {deployment_target: 'vercel', features: ['auth', 'database']})
