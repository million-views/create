...
If you followed the advanced sections of the [make-template tutorial](make-template.md), your LawnMow App template now has dimensions for feature selection. Let's use them.
...
### Advanced Usage (if you completed make-template advanced sections)
