 ...
 * @returns {ReadonlyArray<{ id: keyof typeof CANONICAL_VARIABLES, placeholder: ReturnType<typeof normalizePlaceholders>[number] }>}
 */
 ...
 * @param {{ canonical?: ReturnType<typeof normalizeCanonicalVariables>, placeholders?: ReturnType<typeof normalizePlaceholders> }} params
